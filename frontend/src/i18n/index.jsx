...
const translations = {
  ...
  // ===== Footer =====
  footer: {
    tagline: 'Drug Pharma Egypt — A startup Egyptian pharmaceutical company since 2016. We are the future of nutraceutical and pharmaceutical innovation.',
    company: 'Company',
  ...
  home: {
    ...
    heroSubtitle: 'Drug Pharma Egypt was founded with a fresh take on nutraceutical and pharmaceutical products — bridging the gap with affordable prices, world-class quality, and an NFSA-approved factory.',
    ctaExplore: 'Explore Our Products',
    ctaAbout: 'About the Company',

    trust1Label: 'Established as a startup Egyptian pharmaceutical company',
  ...
  about: {
    ...
    heroSubtitle: 'Drug Pharma Egypt was established with a fresh concept of nutraceutical products — built to fill a real gap with new ideas, fair pricing, and an NFSA-approved manufacturing facility.',
    since2016: 'Since 2016',
    nfsaApproved: 'NFSA Approved',

    storyEyebrow: 'Our Story',
    storyTitle: 'Filling the gap with fresh ideas.',
    storyP1: 'Drug Pharma Egypt is a **startup Egyptian business** established in 2016, founded with a single guiding principle: **nutraceutical products done differently**.',
    ...
    timelineSubtitle: 'From a startup vision to an approved factory — a brief look at the journey.',
    ms1Title: 'Company Founded',
    ms1Desc: 'Drug Pharma Egypt established as a startup focused on nutraceutical innovation.',
