...
const translations = {
  ...
  about: {
    ...
    pillarsTitle: 'Five product pillars.',
    pillarsSubtitle: 'A complementary product mix that addresses everyday wellbeing, point-of-need OTC use, pharmaceutical needs, and B2B manufacturing services.',
    ...
    pillar4Group: 'B2B & Manufacturing Services',
    pillar4Title: 'Active Pharmaceutical Ingredients (APIs)',
    pillar4Desc: 'Premium-grade APIs sourced to guarantee safety, efficacy, and seamless integration into your formulations.',
    pillar5Title: 'Contract Manufacturing',
    pillar5Desc: 'End-to-end manufacturing partnerships offering state-of-the-art facilities, strict compliance, and scalable production.',
    pillarCta: 'Inquire about this service',
  ...
  contact: {
    ...
    topics: {
      ...
      careers: 'Careers',
      apis: 'Active Pharmaceutical Ingredients (APIs)',
